...
class UI {
	...
	static showFrontPage() {
		...
		<div class="frontDiv">
			...
			<p>
				KISS konserten flyttats fram till 23 juni 2021. Vi följer noga utvecklingen
				och sett till rådande situation kommer konserten inte att kunna genomföras
				som planerat. Håll i din biljett - den kommer fortfarande att gälla för det
				nya datumet. Kontakta Ticketmaster för eventuella biljettfrågor!
			</p>
		</div>
		<div class="frontDiv">
			...
			<p>
				...
				utvecklingen och sett till rådande situation kommer konserten inte att kunna
				genomföras som planerat. Håll i din biljett - den kommer fortfarande att
				gälla för det nya datumet. Kontakta Ticketmaster för eventuella
				biljettfrågor!
			</p>
		</div>
